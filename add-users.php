...
<section class="page-register page-bg-color">
                <div class="box-form">
                    <form action="#" method="POST" class="form d-flex flex-column">
                        <h4 class="form-title">Add a User</h4>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <input type="radio" name="type" value="warden" class="input-reset form__input" />
                            <label class="form__label">Warden</label>
                             <input type="radio" name="type" value="admin" class="input-reset form__input" />
